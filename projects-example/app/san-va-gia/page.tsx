          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {courts.map((court) => (
                <Link
                  key={court.id}
                  href={`/san-va-gia/${court.id}`}
                  className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-border/50 block"
                >
                  {/* Image Container */}
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        123 Duong Badminton, Quan Cau Giay, Ha Noi
                      </p>
                    </div>

                    <div className="pt-4 border-t border-border flex items-center justify-between">
                      <div className="flex flex-col">
                        <span className="text-xs text-muted-foreground font-medium">Gia bat dau tu</span>
                        <span className="text-lg font-bold text-foreground">
                          150.000d<span className="text-sm font-normal text-muted-foreground">/gio</span>
                        </span>
                      </div>
                      
                      <div className="w-10 h-10 rounded-full bg-[#059669]/10 flex items-center justify-center text-[#059669] group-hover:bg-[#059669] group-hover:text-white transition-all duration-300">
