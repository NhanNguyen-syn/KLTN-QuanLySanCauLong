...
namespace Botble\RevenueStatistics\Http\Controllers;

use Botble\Base\Facades\Assets;
use Botble\Base\Http\Controllers\BaseController;
use Botble\RevenueStatistics\Services\RevenueStatisticsService;
...
class RevenueDashboardController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        Assets::addScripts(['chart.js'])
            ->addScriptsDirectly('vendor/core/plugins/revenue-statistics/js/revenue-dashboard.js')
            ->addStylesDirectly('vendor/core/plugins/revenue-statistics/css/revenue-dashboard.css');
        ...
        return view('plugins/revenue-statistics::revenue-dashboard', compact(
            'summary',
            'topCourts',
            'revenueByCourt',
            'dateRanges',
    ...
    public function export(Request $request)
    {
        ...
        $bookingQuery = BookingList::query();
        ...
        $callback = function () use ($summary, $dailyData, $topCourts, $bookingDetails, $startDate, $endDate) {
            ...
            foreach ($bookingDetails as $index => $booking) {
                $status = match ($booking->status) {
                    'confirmed', 'completed', 'paid' => 'Hoàn thành',
