...
<div class="revenue-dashboard">
    ...
    <form id="filter-form" class="filter-bar">
        ...
        <a href="{{ route('revenue-dashboard.export', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    const chartDataUrl = '{{ route("revenue-dashboard.chart-data") }}';
    ...
    document.getElementById('filter-form').addEventListener('submit', function() {
        ...
        exportBtn.href = '{{ route("revenue-dashboard.export") }}?start_date=' + startDate + '&end_date=' + endDate;
    });
