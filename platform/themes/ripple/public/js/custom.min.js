    ...
    (a(document).ready(function () {
        ...
        (a('[data-background]').each(function () {
                    ...
                    a(window).scroll(function () {
                        ...
                        (i > n
                            ? 0 == n
                                ...
                                : n > o &&
                                  (e.removeClass('header--sticky-unpin').addClass('header--sticky header--sticky-pin'),
                                  t(s, 'navigation--mobile--active'),
                                  t(c, 'navigation-toggle--active'))
                            : n > o &&
                              (e.addClass('header--sticky-unpin').removeClass('header--sticky-pin'),
            ...
            e.length > 0 &&
                e.on('click', function () {
                    var e = a(this);
                    e.hasClass('navigation-toggle--active')
                        ? (e.removeClass('navigation-toggle--active'), t(n, 'navigation--mobile--active'))
                        : (e.addClass('navigation-toggle--active'), i(n, 'navigation--mobile--active'));
                }),
                ...
                i.length > 0 &&
                    i.each(function () {
                        var i = a(this),
                            ...
                            s = i.data('owl-nav'),
                            l = i.data('owl-dots'),
                            c = i.data('owl-animate-in'),
                            d = i.data('owl-animate-out'),
                            v = i.data('owl-item'),
                            r = i.data('owl-item-xs'),
                            g = i.data('owl-item-sm'),
                            m = i.data('owl-item-md'),
                            u = i.data('owl-item-lg'),
                            h = i.data('owl-nav-left'),
                            w = i.data('owl-nav-right');
                        i.owlCarousel({
                            animateIn: c,
                            animateOut: d,
                            margin: o,
            ...
            (function () {
                ...
                (a(window).scroll(function () {
                    ...
                    t.on('click', function () {
                        a('html, body').animate({ scrollTop: '0px' }, 200);
                    }));
            })());
    }),
        ...
        a(window).on('load resize', function () {
            ...
            ((n = (e = a('.page-header')).data('responsive')),
                ...
                n > a(window).innerWidth()
                    ? (i(e.find('.navigation'), 'navigation--mobile'), o.show())
                    : (o.hide(), t(e.find('.navigation'), 'navigation--mobile')));
        }),
